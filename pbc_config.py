...
# เปิด/ปิดการปรับค่าน้ำเข้า/น้ำอื่นๆ จากหน้าเว็บ
# ปิดไว้เมื่อกรอกข้อมูลในตาราง MonthlyRaw เองอยู่แล้ว
# เพราะการมีสองทางแก้ค่าทำให้ตามรอยยากว่าตัวเลขสุดท้ายมาจากไหน
ENABLE_OVERRIDE_UI = os.environ.get("PBC_ENABLE_OVERRIDE", "0") == "1"

# เปิด/ปิดการบันทึกการดำเนินงานราย DMA
ENABLE_REMARKS = os.environ.get("PBC_ENABLE_REMARKS", "0") == "1"
